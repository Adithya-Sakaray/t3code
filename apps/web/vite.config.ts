...
const configuredCliPackageName = normalizeCliPackageName(process.env.T3CODE_CLI_PACKAGE_NAME);
...
export default defineConfig(() => {
  return {
    ...
    define: {
      ...
      "import.meta.env.T3CODE_CLI_PACKAGE_NAME": JSON.stringify(configuredCliPackageName),
    },
    resolve: {
      tsconfigPaths: true,
